...
var file_proto_pubsub_proto_rawDesc = []byte{
	...
	0x6f, 0x6d, 0x2f, 0x71, 0x71, 0x75, 0x69, 0x71, 0x6c, 0x65, 0x72, 0x72, 0x2f, 0x73, 0x75, 0x62,
	0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x70,
...
func file_proto_pubsub_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_pubsub_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_proto_pubsub_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_proto_pubsub_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Event); i {
			case 0:
				return &v.state
			case 1:
